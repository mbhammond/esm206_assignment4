...
Create code to run a t-test and cohen's d.
...
#### Wrangle Data
Wrangle the data to include weight, hind foot length for juvenile hares.
...
summary(weight_feet_lm)
```

#### Data Interpretation
On average, we expect a 1 mm increase in hind feet length to be associated with a `r weight_feet_lm$estimate[2]` increase in body mass. 
